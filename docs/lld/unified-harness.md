...
| Field | Value |
|-------|-------|
| Status | revision 12 (cleanup, asset-topology, observed-network and cross-platform upgrade contracts implemented) |
| Date | 2026-09-21 |
